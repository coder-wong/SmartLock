...
// rgb数组，每个led灯需要3个byte，所以数组大小是 12 * 3
...
void LED_Light(uint8_t led_number) {
  led_strip_pixels[led_number * 3 + 0] = 255; // green
  led_strip_pixels[led_number * 3 + 1] = 255; // blue
  led_strip_pixels[led_number * 3 + 2] = 255; // red
